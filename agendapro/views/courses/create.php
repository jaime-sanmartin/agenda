        ...
        <div class="col-lg-10 mx-auto">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo BASE_URL; ?>/courses/create" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?php echo htmlspecialchars($data['descripcion'] ?? ''); ?></textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="modalidad" name="modalidad" required>
                                            ...
                                            <option value="online" <?php echo (($data['modalidad'] ?? '') == 'online') ? 'selected' : ''; ?>>Online</option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="duracion_horas" name="duracion_horas" 
                                               value="<?php echo htmlspecialchars($data['duracion_horas'] ?? ''); ?>" min="1" required>
                                    </div>
                                    
                                    <div class="col-md-4 mb-3">
                                        <div class="form-check mt-4">
                                            <input type="checkbox" class="form-check-input" id="publico" name="publico" value="1" <?php echo (($data['publico'] ?? 1) == 1) ? 'checked' : ''; ?>>
